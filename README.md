...
[![Live](https://img.shields.io/badge/▶_live-pak--monitor.com-000000?style=for-the-badge)](https://pak-monitor.com)
&nbsp;
...
<table>
  <tr>
    <td width="33%"><a href="https://pak-monitor.com"><img src="docs/stats.png" alt="Statistics drawer" /></a></td>
    <td width="33%"><a href="https://pak-monitor.com/city/karachi"><img src="docs/city.png" alt="Karachi city page" /></a></td>
    <td width="33%"><a href="https://pak-monitor.com/digest"><img src="docs/digest.png" alt="24-hour digest" /></a></td>
  </tr>
  <tr align="center">
...
- **🧾 Outputs** — a 24-hour **[digest](https://pak-monitor.com/digest)**, per-city pages (`/city/karachi`), **CSV export**, **saved views**, and **shareable URLs** (every filter lives in the query string).
...
| Hosting | Vercel — static export, **zero serverless functions** |
